...
function setupWebRtcPlayer(htmlElement, config) {
	...
	webRtcPlayerObj.onWebRtcOffer = function (offer) {
		...
		console.log('333333333333333 webRtcPlayerObj.onWebRtcOffer');
	...
	webRtcPlayerObj.onWebRtcCandidate = function (candidate) {
		...
		console.log('333333333333333 webRtcPlayerObj.onWebRtcCandidat');
	...
	webRtcPlayerObj.onVideoInitialised = function () 
	{
		...
		console.log('333333333333333 webRtcPlayerObj.onVideoInitialised');
		...
		if (ws && ws.readyState === WS_OPEN_STATE) 
		{
			...
			if (shouldShowPlayOverlay) 
			{
				var img = document.createElement('img');
					...
					//setOverlay('clickableState', img, event => 
							//							{
						console.log('7777777777777777777777 clickableState');
															if (webRtcPlayerObj)
																webRtcPlayerObj.video.play();
	...
	webRtcPlayerObj.onDataChannelConnected = function () 
	{
		...
		console.log('333333333333333 webRtcPlayerObj.onDataChannelConnected');
