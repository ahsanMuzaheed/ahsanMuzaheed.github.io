...
console.log('1111111111111111111111111111ahsanMuzaheed.github.io/app.js');
	...
	if (resizeCheckBox !== null) {
		resizeCheckBox.onchange = function (event) {
			resizePlayerStyle();
			  ...
			  console.info('11111111111111 resizePlayerStyle:')
		};
	}
...
function showConnectOverlay() {
	...
	startText.innerHTML = '111Click to start';
...
function resizeFreezeFrameOverlay() {
	if (freezeFrame.width !== 0 && freezeFrame.height !== 0) {
		...
		if (checkBox !== null && checkBox.checked) {
			...
			console.info('333333333333333333333333333 resizePlayerStyle:')
...
function resizePlayerStyle(event) {
	...
	//{
		...
		//{console.info('5555555555555 resizePlayerStyle:')
			resizePlayerStyleToFillWindow(playerElement);
		//} else 
		//{
		//	console.info('66666666666666 resizePlayerStyle:')
